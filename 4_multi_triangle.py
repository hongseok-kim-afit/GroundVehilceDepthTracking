...
# triangle
st_goal='m_triangle'
# goal1=[-abb/2,0,abb * 1.732/2]
# goal2=[abb/2,0,abb * 1.732/2]
goal1=[0,0,abb]
goal2=[abb * 1.732/2,0,abb/2]
goal4=[0,0,0]
# goal = [goal1,goal2,goal4] # z=forward, x=right
goal = [goal1,goal2,goal4, goal1,goal2,goal4, goal1,goal2,goal4] # z=forward, x=right
